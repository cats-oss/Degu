...
public protocol ApplicationProxyDelegate: class {
    ...
    func applicationProxy(_ proxy: ApplicationProxy, didSendEvent event: Event)
        ...
        func applicationProxy(_ proxy: ApplicationProxy, didSendAction action: Selector, to target: Any?, from sender: Any?, for event: Event?)
    #elseif os(macOS)
    ...
    func applicationProxy(_ proxy: ApplicationProxy, didCallLifeCycle lifeCycle: ViewControllerLifeCycle, ofViewController viewController: ViewController)
}

/// Default implementations to make them Optional.
extension ApplicationProxyDelegate {
    public func applicationProxy(_ proxy: ApplicationProxy, didSendEvent event: Event) {}
    #if os(iOS) || os(tvOS)
        public func applicationProxy(_ proxy: ApplicationProxy, didSendAction action: Selector, to target: Any?, from sender: Any?, for event: Event?) {}
    #elseif os(macOS)
        public func applicationProxy(_ proxy: ApplicationProxy, didSendAction action: Selector, to target: Any?, from sender: Any?) {}
    #endif
    public func applicationProxy(_ proxy: ApplicationProxy, didCallLifeCycle lifeCycle: ViewControllerLifeCycle, ofViewController viewController: ViewController) {}
}
